...
namespace aska.core.security.Authorization.Providers
{
    ...
    public class Facebook28Provider : BaseOAuth20Provider<AccessTokenResult>
    {
        private const string BaseUrl = "https://graph.facebook.com";
        private bool _isMobile;

        public Facebook28Provider(ProviderParams providerParams) : this("Facebook", providerParams)
        {
        }

        protected Facebook28Provider(string name, ProviderParams providerParams) : base(name, providerParams)
        {
                                                                                       ...
                                                                                       Uri redirectUri)
        {
            ...
            var restRequest = new RestRequest("v2.8/oauth/access_token");
        ...
        protected override UserInformation RetrieveUserInformation(AccessToken accessToken)
        {
            ...
            try
            {
                var restRequest = new RestRequest("v2.8/me");
        ...
        public bool IsMobile
        {
            ...
            set
            {
                ...
                var url = string.Format("https://{0}.facebook.com/v2.8/dialog/oauth",
                    IsMobile
                        ? "m"
                        : "www");
