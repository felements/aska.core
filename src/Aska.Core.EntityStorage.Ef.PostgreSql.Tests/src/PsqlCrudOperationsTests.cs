...
namespace Aska.Core.EntityStorage.Ef.PostgreSql.Tests
{
    ...
    public class PsqlCrudOperationsTests : DbContextCrudOperationsTest<TestPostgresqlContext>, IClassFixture<DbContextFixture<TestPostgresqlContext>> 
    {
        public PsqlCrudOperationsTests(DbContextFixture<TestPostgresqlContext> contextFixture) : base(contextFixture)
        {
        }
